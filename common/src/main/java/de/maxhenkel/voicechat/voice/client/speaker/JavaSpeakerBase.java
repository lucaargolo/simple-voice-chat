...
public abstract class JavaSpeakerBase implements Speaker {
    ...
    private void playInternal(short[] data, float volume, @Nullable Vec3 position, @Nullable String category, float maxDistance) {
    ...
    protected abstract short[] convertToStereo(short[] data, @Nullable Vec3 position);
